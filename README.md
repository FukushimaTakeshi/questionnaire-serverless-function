...
This is a sample template for hello_ruby - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name hello_ruby --tail
```
...
```bash
aws cloudformation delete-stack --stack-name hello_ruby
```
